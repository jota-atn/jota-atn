...
<div style="display: flex; gap: 5px; align-items: flex-start; margin: 0; padding: 0; font-size: 0.875rem;">
  <!-- Coluna da esquerda -->
  <div style="flex: 1; display: flex; flex-direction: column; gap: 5px; margin: 0; padding: 0; max-width: 20%;">
    <img 
      style="width: 100%; height: auto; max-height: 125px; display: block; border-radius: 5px;" 
  ...
  <!-- Coluna da direita -->
  <div style="flex: 2; margin: 0; padding: 0; max-width: 40%;">
    <img 
