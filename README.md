...
<div style="display: flex; gap: 10px; align-items: flex-start; margin: 0; padding: 0">
  <!-- Coluna da esquerda -->
  <div style="flex: 1; display: flex; flex-direction: column; gap: 5px; margin: 0; padding: 0; max-width: 45%;">
    <img 
  ...
  <!-- Coluna da direita -->
  <div style="flex: 2; margin: 0; padding: 0; max-width: 55%;">
    <img 
      style="width: 100%; height: 270; display: block; border-radius: 5px;" 
