...
<div style="display: flex; gap: 5px; align-items: flex-start; margin: 0; padding: 0;">
  <!-- Coluna da esquerda -->
  <div style="flex: 1; display: flex; flex-direction: column; gap: 5px; margin: 0; padding: 0; max-width: 35%;">
    <img 
      style="width: 100%; height: auto; max-height: 200px; display: block; border-radius: 5px;" 
  ...
  <!-- Coluna da direita -->
  <div style="flex: 1.5; margin: 0; padding: 0; max-width: 55%;">
    <img 
